        ...
        <form class="mx-2" action="#" method="get">
          ...
          <div class="d-flex justify-content-end">
            ...
            <select name="delivery_status" class="form-control mr-1" id="">
              <option disabled selected>delivery_status</option>
              ...
              <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                <thead>
                  <tr role="row">
                    ...
                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Your reward</th>
                    ...
                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">See order details</th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr>
                    <td>{{$order->id}}</td>
                    <td><strong>order create: </strong>{{$order->created_at}} <br><strong> @if($order->delivery_status == 'returned') returned date : @else successed date @endif </strong>{{$order->updated_at}} </td>
                    ...
                    <td><strong>{{$order->delivery_price_shipping}} Dhs</strong> </td>
                    <td>{{$order->status}} </td>
