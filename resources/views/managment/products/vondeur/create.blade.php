            ...
            <form action="{{ route('vondeur.products.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-8">
                        ...
                        <div class="form-group ">
                            <label for="summernote">nom</label>
                        ...
                        <div id="option1" class="form-group  d-none mt-3 mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-8 option1inpute">
                                    ...
                                    <input type="text" name="values[]" class="form-control option1" value="red,blue,green" style="width: 100% !important;height:100% !important;" data-role="tagsinput" id="option1inpute">
                                </div>
                        ...
                        <div id="option2" class="form-group  d-none mt-3 mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-8 option2inpute">
                                    <small class="small-hint">les option doit être séparé par virgule ','</small>
                                    <input type="text" name="values[]" class="form-control option2" value="small,big,medium" style="width: 100% !important;height:unset" data-role="tagsinput" id="option2inpute">
                                </div>
                                <div class="col-1" style="align-self: center;">
                        ...
                        <div id="option3" class="form-group  d-none mt-3 mb-3" style="padding-bottom: 20px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-8 option3inpute">
                                    <small class="small-hint">les option doit être séparé par virgule ','</small>
                                    <input type="text" name="values[]" class="form-control option3" value="agadir,rabat" style="width: 100% !important;height:100% !important;" data-role="tagsinput" id="option3inpute">
                                </div>
                                <div class="col-1" style="align-self: center;">
