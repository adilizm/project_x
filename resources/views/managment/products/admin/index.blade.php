              ...
              <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>0</td>
                    <td>
                      <form action="{{ route('admin.products.admin_update_status')}}" method="post">
                        @csrf
                    ...
                    <td>
                      <form action="{{ route('admin.products.admin_update_confirmation_product')}}" method="post">
                        @csrf
                        <div class="form-group">
                          <input type="hidden" name="product_id" value="{{encrypt($product->id)}}">
                    ...
                    <td>
                      <a href="{{ route('admin.products.edit',encrypt($product->id)) }}" class="mx-1"><i class="fas fa-edit"></i></a>
