      ...
      <div class="w-full  flex my-4 h-56 md:h-80 lg:h-96">
         ...
         <div class="hidden lg:block w-1/4 bg-white rounded overflow-auto pr-5">
            <ul class="my-4 w-full">
               <li class="py-2 list-none" id='b1' onclick="funtc('b1')">
                  <button
               ...
               <!-- ********************************************************************** -->
               <li class="py-2 list-none" id='b2' onclick="funtc('b2')">
                  <button
                     class="flex items-center justify-between w-full text-gray-500 font-semibold focus:text-purple-800 text-sm">
                     <span class="flex items-center justify-between">
                        <span class="flex w-5 h-5 mx-2 items-center justify-center">
               ...
               <!-- ********************************************************************** -->
               <li class="py-2 list-none" id='b3' onclick="funtc('b3')">
                  <button
                     class="flex items-center justify-between w-full text-gray-500 font-semibold focus:text-purple-800 text-sm">
                     <span class="flex items-center justify-between">
                        <span class="flex w-5 h-5 mx-2 items-center justify-center">
                           <svg xmlns="http://www.w3.org/2000/svg" width="25.143" height="22" viewBox="0 0 25.143 22"
                              fill="currentColor" class="max-h-full max-w-full">
               ...
               <li class="list-none px-8 text-gray-500 hidden pb-4">
                  <ul>
                     <li class="py-1"><button
                           class="flex items-center w-full py-2 font-semibold  focus:text-purple-800 text-sm"><span>Nuts
                              &amp; Biscuits</span><span class="ms-auto"></span></button></li>
                     <li class="py-1"><button
                           class="flex items-center w-full py-2 font-semibold  focus:text-purple-800 text-sm"><span>Chocolates</span><span
                              class="ms-auto"></span></button></li>
                     <li class="py-1"><button
                           class="flex items-center w-full py-2 font-semibold  focus:text-purple-800 text-sm"><span>Crisps</span><span
                              class="ms-auto"></span></button></li>
                     <li class="py-1"><button
                           class="flex items-center w-full py-2 font-semibold  focus:text-purple-800 text-sm"><span>Noodles
                              &amp; Pasta</span><span class="ms-auto"></span></button></li>
                     <li class="py-1"><button
                           class="flex items-center w-full py-2 font-semibold  focus:text-purple-800 text-sm"><span>Sauce</span><span
                              class="ms-auto"></span></button></li>
                     <li class="py-1"><button
                           class="flex items-center w-full py-2 font-semibold  focus:text-purple-800 text-sm"><span>Soup</span><span
                              class="ms-auto"></span></button></li>
                  </ul>
               </li>
               <!-- ********************************************************************** -->
               <li class="py-2 list-none" id='b4' onclick="funtc('b4')">
                  <button
                     class="flex items-center justify-between w-full text-gray-500 font-semibold focus:text-purple-800 text-sm">
                     <span class="flex items-center justify-between">
                        <span class="flex w-5 h-5 mx-2 items-center justify-center">
               ...
               <li class="list-none px-8 text-gray-500 hidden pb-4">
                  <ul>
                     <li class="py-1"><button
                           class="flex items-center w-full py-2 font-semibold focus:text-purple-800 transition-all text-sm text-gray-600"><span>Cat
                              Food</span><span class="ms-auto"></span></button></li>
                     <li class="py-1"><button
                           class="flex items-center w-full py-2 font-semibold focus:text-purple-800 transition-all text-sm text-gray-600"><span>Dog
                              Food</span><span class="ms-auto"></span></button></li>
                     <li class="py-1"><button
                           class="flex items-center w-full py-2 font-semibold focus:text-purple-800 transition-all text-sm text-gray-600"><span>Accessories</span><span
                              class="ms-auto"></span></button></li>
                  </ul>
               </li>
               <!-- ********************************************************************** -->
               <li class="py-2 list-none" id='b5' onclick="funtc('b5')">
                  <button
                     class="flex items-center justify-between w-full text-gray-500 font-semibold focus:text-purple-800 text-sm">
                     <span class="flex items-center justify-between">
                        <span class="flex w-5 h-5 mx-2 items-center justify-center">
               ...
               <li class="list-none px-8 text-gray-500 hidden pb-4">
                  ...
                  <ul>
                     <li class="py-1"><button
                           class="flex items-center w-full py-2 font-semibold focus:text-purple-800 text-sm"><span>Air
                              Freshner</span><span class="ms-auto"></span></button></li>
                     <li class="py-1"><button
                           class="flex items-center w-full py-2 font-semibold focus:text-purple-800 text-sm"><span>Cleaning
                              Products</span><span class="ms-auto"></span></button></li>
                     <li class="py-1"><button
                           class="flex items-center w-full py-2 font-semibold focus:text-purple-800 text-sm"><span>Kitchen
                              Accessories</span><span class="ms-auto"></span></button></li>
                     <li class="py-1"><button
                           class="flex items-center w-full py-2 font-semibold focus:text-purple-800 text-sm"><span>Laundry</span><span
                              class="ms-auto"></span></button></li>
                  </ul>
