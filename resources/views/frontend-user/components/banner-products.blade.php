<!-- products 1-->
   ...
   <div class="">
   <div class="grid grid-cols-2 sm:grid-cols-3 gap-3 md:grid-cols-4 lg:grid-cols-5 2xl:grid-cols-6 3xl:grid-cols-7">
       <div class="glide-banner w-full lg:pl-4 h-full">
               <div class="relative h-full">
                  <div class="glide__track h-full" data-glide-el="track">
                     <div class="glide__slides h-full">
                        @foreach([0,1,2,3,5,4,6,7,8,9,10] as $slider)
         <article class="glide__slide h-full product-card cart-type-neon border border-border-200 rounded h-full bg-white overflow-hidden shadow-sm transition-all duration-200 hover:shadow transform hover:-translate-y-0.5">
            <div class="relative flex items-center justify-center cursor-pointer w-auto h-36">
               <span class="sr-only">Product Image</span>
               <div><img alt="Apples" sizes="100vw" src="./public/Apples.jpg" decoding="async" data-nimg="true" class="product-image" style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%; object-fit: contain;"></div>
               <div class="absolute top-3 right-3 md:top-4 md:end-4 rounded text-xs leading-6 font-semibold px-1.5 sm:px-2 md:px-2.5 bg-green-600 text-light">20%</div>
            </div>
            <header class="p-3 md:p-6">
               <div class="flex items-center mb-2"><span class="text-sm md:text-base text-heading font-semibold">$1.60</span><del class="text-xs md:text-sm text-gray-500 ml-2">$2.00</del></div>
               <h3 class="text-xs md:text-sm text-gray-600 truncate mb-4 cursor-pointer">Apples</h3>
               <div class="flex overflow-hidden w-full h-7 md:h-9 bg-green-600 text-light rounded">
